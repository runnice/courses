...
//Professor, boa noite! Semana foi atribulada, fiz aos 45º do segundo tempo para não ficar sem entregar. 
//Que Jesus ilumine seu coração ao corrigir isso! 
...
int main(){
	...
	do{
        ...
        case 4:
        	...
        	cout<<"O Total de todas as vendas cadastrado é: "<<totalVendas<<endl;
            break;
        case 5:
