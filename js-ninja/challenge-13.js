...
*/
// ?
let nordeste = ['Bahia', 'Pernambuco', 'Recife'];
/*
...
// ?
let everyStateMoreThanSeven = brasil.every(function(estado){ 
    return estado.length > 7 ?  console.log('Sim, todos os estados tem mais de 7 letras!') : console.log('Nem todos os estados tem mais de 7 letras!');
})
/*
...
// ?
let cearaInBrasil = brasil.some(function (item){
    return item === 'Ceará' ? console.log('Ceará está incluído!') : console.log('Ceará não foi incluído :(')
})
/*
