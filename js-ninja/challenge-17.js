...
// ?
text.replace(/Manuel Marques de Sousa/, 'Vinicius Oliveira')
...
// ?
text.replace(/brasileiro/, 'baiano')
/*
...
// ?
console.log(text.replace(/O Centauro de Luvas/g, function(texto){
...
// ?
let getMonthNumber = function(nomeDoMes){
    let mes = {
        janeiro: '01',
        fevereiro: '02',
        março: '03',
...
let mostrarMes = function(mes){
    let mesMinusculo = mes.toLowerCase();
    return "O mês de " + mesMinusculo +   " é representado pelo número " + getMonthNumber(mesMinusculo) + ".";
}
console.log(mostrarMes('março'));
console.log(mostrarMes('SETEMBRO'));
console.log(mostrarMes('dezembro'));
...
console.log( '\nReplace de datas:' );
// ?
let replaceDate = function replaceDate(regex, dia, mes, ano){
