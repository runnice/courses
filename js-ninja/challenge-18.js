...
function formatCPF( cpf ) {
    ...
    return cleanCPF( cpf ).replace( regex, format );

}

console.log(formatCPF("049-214 3421-1"))
console.log(formatCPF("210.458.522-05"))
console.log(formatCPF("735 500 794 - 22"))
console.log(formatCPF("101.123-131x32"))
...
// ?
let matchMes = function matchMes (text){
    return text.match(/j\w{3}o/g);

}
console.log(matchMes("Os meses de janeiro, junho e julho começam com a letra j."));
/*
...
// ?
let matchHmlt = function matchHmlt(text){
    return text.match(/<\w+>/g);

}
console.log(matchHmlt("<div><section><blockquote>Texto <img /></blockquote></section></div>"))
/*
